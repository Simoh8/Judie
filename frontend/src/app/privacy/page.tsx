        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="card-ios ios-shadow-lg p-8 mb-12">
            ...
            <p className="text-foreground/60 mb-4">
              At Actually Doing, we believe that privacy is a fundamental right. We are committed to protecting your personal information and being transparent about our data practices. This privacy policy applies to our website, mobile applications, and all services we provide.
            </p>
            <p className="text-foreground/60">
              By using Actually Doing, you agree to the collection and use of information in accordance with this policy. If you disagree with any part of this policy, please do not use our services.
            </p>
          </div>
          ...
          <div className="card-ios ios-shadow-lg p-8 bg-gradient-to-br from-ios-blue/5 to-purple-500/5">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                ...
                <a
                  href="mailto:privacy@actuallydoing.com"
                  className="text-ios-blue hover:underline font-medium"
                >
                  privacy@actuallydoing.com
                </a>
              </div>
            </div>
          </div>
