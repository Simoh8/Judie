...
const values = [
  ...
  },
  {
    ...
    description:
      "We built Actually Doing for brains that struggle with traditional productivity advice — especially those with ADHD, anxiety, or executive function differences.",
    color: "text-red-500",
...
const team = [
  {
    ...
    bio: "Cognitive neuroscientist with a decade of research into attention disorders. Built Actually Doing after seeing how body doubling transformed her own ADHD patients.",
    initials: "AK",
  ...
  },
  {
    name: "Marcus Webb",
    role: "Co-founder & CEO",
    bio: "Former remote team lead who struggled with distraction. Created the first Actually Doing sessions in a Zoom call with 12 friends — and never looked back.",
    initials: "MW",
  ...
  },
  {
    ...
    bio: "Community builder and certified ADHD coach. Ensures every Actually Doing session feels safe, inclusive, and genuinely productive for all kinds of minds.",
    initials: "PS",
...
const milestones = [
  { year: "2021", event: "Actually Doing founded after a 12-person body-doubling experiment on Zoom." },
      ...
      <section className="min-h-[60vh] flex items-center justify-center pt-24 pb-16 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center animate-slide-up relative z-10">
          ...
          <p className="text-xl md:text-2xl text-foreground/70 max-w-3xl mx-auto leading-relaxed">
            Actually Doing was built for people who know they&apos;re capable of great
          ...
          <div className="card-ios ios-shadow-lg p-10 md:p-16 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <blockquote className="text-2xl md:text-3xl font-semibold text-foreground leading-relaxed mb-8">
                ...
                getting started and staying present. Actually Doing exists to solve
                exactly that.&rdquo;
              </blockquote>
          ...
          <div className="card-ios ios-shadow-lg p-12 md:p-16 text-center relative overflow-hidden animate-slide-up">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-foreground/70 mb-10 max-w-2xl mx-auto leading-relaxed">
                Thousands of people are already doing their best work with Actually Doing.
