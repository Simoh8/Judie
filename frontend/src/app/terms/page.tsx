  ...
  const sections = [
    {
      ...
      content: [
        "By accessing and using Actually Doing, you accept and agree to be bound by these Terms of Service",
    ...
    },
    {
      ...
      content: [
        "Actually Doing provides focus sessions and productivity tools",
        "We strive to maintain service availability but cannot guarantee uninterrupted access",
        "We may update or discontinue features with or without notice",
        "Third-party services integrated into Actually Doing have their own terms",
    ...
    },
    {
      ...
      content: [
        "All content, features, and functionality are owned by Actually Doing",
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-foreground/60 max-w-2xl mx-auto">
              These terms govern your use of Actually Doing services. Please read them carefully before using our platform.
            </p>
          ...
          <div className="card-ios ios-shadow-lg p-8 mb-12">
            ...
            <p className="text-foreground/60 mb-4">
              These Terms of Service (&quot;Terms&quot;) govern your use of the Actually Doing website, mobile applications, and related services (collectively, the &quot;Service&quot;). By accessing or using the Service, you agree to be bound by these Terms.
            </p>
          ...
          <div className="card-ios ios-shadow-lg p-8 mb-12">
            ...
            <p className="text-foreground/60 mb-4">
              To the maximum extent permitted by law, Actually Doing shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses.
            </p>
            <p className="text-foreground/60">
          ...
          <div className="card-ios ios-shadow-lg p-8 mb-12">
            ...
            <p className="text-foreground/60">
              These Terms shall be governed by and construed in accordance with the laws of the jurisdiction in which Actually Doing is headquartered, without regard to its conflict of law provisions. Any disputes arising under these Terms shall be resolved through binding arbitration.
            </p>
          </div>
          ...
          <div className="card-ios ios-shadow-lg p-8 bg-gradient-to-br from-ios-blue/5 to-purple-500/5">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                ...
                <a
                  href="mailto:legal@actuallydoing.com"
                  className="text-ios-blue hover:underline font-medium"
                >
                  legal@actuallydoing.com
                </a>
              </div>
            </div>
          </div>
