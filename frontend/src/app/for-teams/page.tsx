  ...
  const benefits = [
    {
      ...
      description: "Teams report 40% increase in focused work hours within the first month of using Actually Doing.",
      stat: "40%",
    },
    {
      icon: Users,
  ...
  const testimonials = [
    {
      ...
      quote: "Actually Doing transformed how our engineering team works. We've seen a massive improvement in code quality and shipping speed.",
    },
    {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center card-ios ios-shadow-lg p-12 bg-gradient-to-br from-ios-blue/5 to-purple-500/5">
            ...
            <p className="text-foreground/60 mb-8 max-w-xl mx-auto">
              Schedule a demo to see how Actually Doing can help your team achieve deep work at scale.
            </p>
