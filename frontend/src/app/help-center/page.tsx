...
export default function HelpCenterPage() {
  ...
  const helpArticles = [
    ...
    },
    {
      ...
      category: "account",
      content: "How to upgrade, downgrade, or cancel your Actually Doing subscription.",
    },
    {
      id: 5,
    ...
    },
    {
      ...
      category: "getting-started",
      content: "Guide to using Actually Doing on your mobile device for focus on the go.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-foreground/60 max-w-2xl mx-auto">
              Find answers to your questions and get the most out of Actually Doing.
            </p>
          ...
          <div className="card-ios ios-shadow-lg p-12 bg-gradient-to-br from-ios-blue/5 to-purple-500/5 text-center">
            ...
            <p className="text-foreground/60 mb-8 max-w-xl mx-auto">
              Our support team is here to help you get the most out of Actually Doing.
            </p>
            <a
              href="/contact"
