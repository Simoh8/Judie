      ...
      <div className="relative bg-white dark:bg-ios-gray-900 rounded-3xl p-8 w-full max-w-md animate-scale-in">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <Lock size={20} className="absolute left-3 top-1/2 -translate-y-1/2 text-foreground/40" />
              <input
                type="password"
                value={password}
        ...
        <div className="relative my-6">
          <div className="absolute inset-0 flex items-center">
            <div className="w-full border-t border-ios-gray-200 dark:border-ios-gray-700"></div>
          </div>
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-white dark:bg-ios-gray-900 text-foreground/60">Or continue with</span>
          </div>
        </div>
