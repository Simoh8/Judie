...
const defaultTestimonials = [
  {
    ...
    content: "Actually Doing has completely transformed how I work. The body doubling sessions keep me accountable without feeling pressured. I've never been more productive.",
    rating: 5,
    avatar: "SC",
  },
  {
    ...
    content: "As someone with ADHD, I've tried every productivity tool out there. Actually Doing is different - it actually works with my brain, not against it.",
    rating: 5,
    avatar: "MJ",
  },
  {
